...
[Latest Official Build v1.1.2.2](https://github.com/Terence0816/RustDesk-QuickHost/releases/tag/v1.1.2.2) |
...
* Official `v1.1.2.2` build: [RustDeskQS.exe](https://github.com/Terence0816/RustDesk-QuickHost/releases/tag/V1.1.2.2)
...
* 官方 `v1.1.2.2` 版本：[RustDeskQS.exe](https://github.com/Terence0816/RustDesk-QuickHost/releases/tag/V1.1.2.2)
